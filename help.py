...
${Fore.GREEN}============================== HELP  ==============================
    ...
    if (int(que_ans)==1):
        ...
        To buy proxies go to https://t.me/live_all_class and ask proxy.
        ...
        Or you can report bugs at https://t.me/live_all_class
        ...
        ''')
        help_msg()
        webbrowser.open('http://t.me/live_all_class')
    elif(int(que_ans)==4):
        clearConsole()
